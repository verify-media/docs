...
- A smart contract which stores the reference to metadata and licenses of a digital asset by binding it with a token that represents that asset through a unique identifier.
